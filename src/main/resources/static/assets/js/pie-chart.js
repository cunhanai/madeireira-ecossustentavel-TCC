...
if ($('#seolinechart8').length) {
	...
	$.ajax({ 
		...
		success : function success(numMadeira) { 
			// you can also declare function outside 
			// and give function name here instead 
		},
		error: function error(event, request) { 
			// similarly for error also you may have some function 
		} 
	}); 
